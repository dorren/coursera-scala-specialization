...
// if Signal and Var are not recognize,
// * right click web-ui folder in left navigator.
// * click "Open Module Settings" near bottom of the menu
// * click "+" in the config panel
// * select "module dependencies" option.
// * add "root" , then click "OK"
...
object CalculatorUI extends js.JSApp {
  ...
  def setupTweetMeasurer(): Unit = {
    ...
    println("setupTweetMeasurer color " + color())
    Signal {
